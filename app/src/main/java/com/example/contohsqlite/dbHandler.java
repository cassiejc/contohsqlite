...
public class dbHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String Query = "CREATE TABLE "+TB_NAME+"("+KEY_ID+" INTEGER PRIMARY KEY,"+KEY_NAME+" TEXT,"+KEY_PHONE+" TEXT"+")";
    ...
    Contact getContact (int id){
        ...
        Cursor c = db.query(TB_NAME, new String[] {KEY_ID, KEY_NAME, KEY_PHONE}, KEY_ID+"=?", new String[]{String.valueOf(id)}, null, null, null);
        if(c!=null)
            c.moveToFirst();
